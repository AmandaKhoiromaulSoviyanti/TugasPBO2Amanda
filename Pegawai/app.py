...
@app.route('/')
def index():
    pegawai_tetap = PegawaiTetap("Nabila Rahmadanti", "22012", "1", 5000000)
    pegawai_harian = PegawaiHarian("Faisal Renaldy", "22067", "2", 120, 5000)
    pegawai_kontrak = PegawaiKontrak("Fathiya", "22094", "3", 6, 2000000)
